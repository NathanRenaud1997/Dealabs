 ...
 */
final class Version20210609133144 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_bon_plan (user_id INT NOT NULL, bon_plan_id INT NOT NULL, INDEX IDX_1E3C12F2A76ED395 (user_id), INDEX IDX_1E3C12F22E81A751 (bon_plan_id), PRIMARY KEY(user_id, bon_plan_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE user_code_promo (user_id INT NOT NULL, code_promo_id INT NOT NULL, INDEX IDX_FB21455BA76ED395 (user_id), INDEX IDX_FB21455B294102D4 (code_promo_id), PRIMARY KEY(user_id, code_promo_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
