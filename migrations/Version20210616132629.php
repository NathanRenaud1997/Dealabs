 ...
 */
final class Version20210616132629 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE alerte_bon_plan (alerte_id INT NOT NULL, bon_plan_id INT NOT NULL, INDEX IDX_1EDEBCB72C9BA629 (alerte_id), INDEX IDX_1EDEBCB72E81A751 (bon_plan_id), PRIMARY KEY(alerte_id, bon_plan_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE alerte_code_promo (alerte_id INT NOT NULL, code_promo_id INT NOT NULL, INDEX IDX_474170162C9BA629 (alerte_id), INDEX IDX_47417016294102D4 (code_promo_id), PRIMARY KEY(alerte_id, code_promo_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
